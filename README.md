...
2) Learn sprite multiplexing on the C64 using IRQs. Oscar64 includes sprite-muxing and irq libraries, but I wanted to write my own. I've ended up with 38 stable, flicker-free sprites onscreen at once, which is pretty cool.
