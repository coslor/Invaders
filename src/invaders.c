...
//alive,x,y,speed_x,speed_y,num_images,image_handles,image_num (to start),sprite_num,fps,color
        {1, 50, 50, 1,0,2,{128,129},0, 2,4.0, 2},
    ...
    // {
    //     {1, 50, 75, 1,0,2,{128,129},0, 2,4.0, 2},
    //     {1,100, 75, 1,0,2,{128,129},1, 3,4.0, 3},
    //     {1,150, 75, 1,0,2,{128,129},0, 4,4.0, 4},
    //     {1,200, 75, 1,0,2,{128,129},1, 5,4.0, 5},
    //     {1,250, 75, 1,0,2,{128,129},0, 6,4.0, 6},
    //     {1,300, 75, 1,0,2,{128,129},1, 7,4.0, 7}
    // },
    // {
    //     {1, 50,100, 1,0,2,{128,129},0, 2,4.0, 2},
    //     {1,100,100, 1,0,2,{128,129},1, 3,4.0, 3},
    //     {1,150,100, 1,0,2,{128,129},0, 4,4.0, 4},
    //     {1,200,100, 1,0,2,{128,129},1, 5,4.0, 5},
    //     {1,250,100, 1,0,2,{128,129},0, 6,4.0, 6},
    //     {1,300,100, 1,0,2,{128,129},1, 7,4.0, 7}
    // },
    // {
    //     {1, 50,125, 1,0,2,{128,129},0, 2,4.0, 2},
    //     {1,100,125, 1,0,2,{128,129},1, 3,4.0, 3},
    //     {1,150,125, 1,0,2,{128,129},0, 4,4.0, 4},
    //     {1,200,125, 1,0,2,{128,129},1, 5,4.0, 5},
    //     {1,250,125, 1,0,2,{128,129},0, 6,4.0, 6},
    //     {1,300,125, 1,0,2,{128,129},1, 7,4.0, 7}
    // },
    // {
    //     {1, 50,150, 1,0,2,{128,129},0, 2,4.0, 2},
    //     {1,100,150, 1,0,2,{128,129},1, 3,4.0, 3},
    //     {1,150,150, 1,0,2,{128,129},0, 4,4.0, 4},
    //     {1,200,150, 1,0,2,{128,129},1, 5,4.0, 5},
    //     {1,250,150, 1,0,2,{128,129},0, 6,4.0, 6},
    //     {1,300,150, 1,0,2,{128,129},1, 7,4.0, 7}
    // },
    {
        {1, 50,175, 1,0,2,{128,129},0, 2,4.0, 2},
        {1,100,175, 1,0,2,{128,129},1, 3,4.0, 3},
        {1,150,175, 1,0,2,{128,129},0, 4,4.0, 4},
        {1,200,175, 1,0,2,{128,129},1, 5,4.0, 5},
        {1,250,175, 1,0,2,{128,129},0, 6,4.0, 6},
        {1,300,175, 1,0,2,{128,129},1, 7,4.0, 7}
    }
};
